...
import com.example.knurling_dietinbody.model.diaryModel
...
class DiaryWriteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        save_btn.setOnClickListener {
            ...
            diaryModel.diet_name = weight_txt.text.toString()
            diaryModel.diet_date = cal.timeInMillis
            diaryModel.diet_detail = menu_txt.text.toString()
